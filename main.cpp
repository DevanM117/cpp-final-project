...
int main() {
    ...
    db.addCharacter({"Bobby Drake", "Iceman", "X-Men", {"Cryokinesis", "Ice form"}, "Omega"});
    db.addCharacter({"Kurt Wagner", "Nightcrawler", "X-Men", {"Teleportation", "Enhanced agility"}, "Beta"});
    db.addCharacter({"Piotr Rasputin", "Colossus", "X-Men", {"Metal transformation", "Super strength"}, "Beta"});
    db.addCharacter({"Sean Cassidy", "Banshee", "X-Men", {"Sonic scream", "Flight"}, "Beta"});
    db.addCharacter({"Shiro Yoshida", "Sunfire", "X-Men", {"Plasma blasts", "Flight"}, "Beta"});
    ...
    db.addCharacter({"Anna Marie LeBeau", "Rogue", "X-Men", {"Power absorption", "Flight", "Super strength"}, "Beta"});
    db.addCharacter({"Remy LeBeau", "Gambit", "X-Men", {"Kinetic energy charge", "Enhanced agility"}, "Beta"});
    db.addCharacter({"Jubilation Lee", "Jubilee", "X-Men", {"Plasmoid fireworks"}, "Beta"});
    db.addCharacter({"Betsy Braddock", "Psylocke", "X-Men", {"Telepathy", "Psychic weapons"}, "Beta"});
    ...
    db.addCharacter({"Nathan Summers", "Cable", "X-Men", {"Telekinesis", "Telepathy", "Cyborg enhancements"}, "Beta"});
    ...
    db.addCharacter("Roberto da Costa", "Sunspot", "X-Men", {"Solar energy absorption", "Flight", "Super strength"}, "Beta");
    ...
    db.addCharacter("Raven Darkhölme", "Mystique", "X-Men", {"Shapeshifting"}, "Beta");
    db.addCharacter("Victor Creed", "Sabretooth", "X-Men", {"Regeneration", "Super strength", "Enhanced senses"}, "Beta");
    db.addCharacter("Cain Marko", "Juggernaut", "X-Men", {"Super strength", "Invulnerability"}, "Not a mutant");
    db.addCharacter("St. John Allerdyce", "Pyro", "X-Men", {"Fire manipulation (not creation)"}, "Beta");
    db.addCharacter("Dominikos Petrakis", "Avalanche", "X-Men", {"Seismic wave generation"}, "Beta");
    db.addCharacter("Frederick Dukes", "Blob", "X-Men", {"Immovable", "Super strength"}, "Beta");
    db.addCharacter("Mortimer Toynbee", "Toad", "X-Men", {"Enhanced agility", "Prehensile tongue"}, "Beta");
    db.addCharacter("Jason Wyngarde", "Mastermind", "X-Men", {"Illusion casting"}, "Beta");
    db.addCharacter("Emma Frost", "Emma Frost", "X-Men", {"Telepathy", "Diamond form"}, "Omega");
    db.addCharacter("Sebastian Shaw", "Sebastian Shaw", "X-Men", {"Kinetic energy absorption"}, "Beta");
